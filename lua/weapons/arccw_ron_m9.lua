...
SWEP.ViewModel = "models/weapons/m9ron.mdl"
SWEP.WorldModel = "models/weapons/m9ron.mdl"
...
SWEP.FirstShootSound = "weapons/pistols/m9/fire.wav"
SWEP.ShootSound = "weapons/pistols/m9/fire.wav"
SWEP.ShootSoundSilenced = "weapons/pistols/m9/firesil.wav"
SWEP.DistantShootSound = "weapons/pistols/m9/firesil.wav"
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FrameRate = 60,
		SoundTable = {
            {s = "weapons/pistols/m9/magout.wav", t = 0.2},
			{s = "weapons/pistols/m9/magin.wav", t = 1.7},
        },
        LHIK = true,
        LHIKIn = 0.5,
        LHIKOut = 0.5,
    ...
    ["reload_empty"] = {
		...
		SoundTable = {
            {s = "weapons/pistols/m9/magout.wav", t = 0.2},
			{s = "weapons/pistols/m9/magin.wav", t = 1.7}, 
			{s = "weapons/pistols/m9/slideforward.wav", t = 2},
        },
        LHIK = true,
        LHIKIn = 0.5,
        LHIKOut = 0.5,
